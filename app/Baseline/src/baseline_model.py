...
import scrape_dates as scrape_dates



parks = ["North","West","Rose Garden","Health Sciences","Fraser River","Thunderbird","University West Blvd"]
...
class random_baseline_model():
    def __init__(self, filename, school_terms=False, import_filename="None"):
        ...
        if import_filename != "None":
            ...
            self.data = pd.read_csv(filename,
                            usecols=["Timestamp", "North","West","Rose Garden","Health Sciences","Fraser River","Thunderbird","University West Blvd"],
                            index_col=[0],
                            parse_dates=[0])
    ...
    def save_model(self, group_file_name, term_dates_full_filename):
        ...
        parking_lots = ["North","West","Rose Garden","Health Sciences","Fraser River","Thunderbird","University West Blvd"]
        park = "North"
