...
def main():
    ...
    for parkade in parkades:
        ...
        #start_date = pd.to_datetime("2024-08-01 23:00:00")
        ...
        output_filename = f'shortterm_predictions_{parkade}.csv'
